    ...
    <section>
      <article>
        <form class="formulario" @submit.prevent="agregar">
          <div class="form">
            <h3 class="bold">Agregar Categoria</h3>
            <input class="bold" type="text" v-model="categoria.nombre" placeholder="Nombre del categoria" required />
            <div class="enviar">
...
export default {
  ...
  methods: {
    agregar(event) {
      ...
      .then((data) => {
        console.log(data);        
        alert("Categoria Agregrado satisfactoriamente!");
