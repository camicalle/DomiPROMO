    ...
    <section>
      <article>
        <form class="formulario" @submit.prevent="editar">
          <div class="form">
            <h3 class="bold">Editar Producto</h3>
            <input class="bold" type="text" v-model="productos.nombre" placeholder="Nombre del producto" required />
            <textarea class="bold" cols="55" rows="7" type="text" v-model="productos.descripcion" placeholder="Descripción del producto" required></textarea>
            <input class="bold" type="number" v-model="productos.precio" placeholder="Precio del producto" required />
            <div class="enviar">
...
export default {
  ...
  created(){
    fetch('https://62b52002da3017eabb151779.mockapi.io/producto/' + this.$route.params.id)
  ...
  methods: {
    editar(event) {
      fetch('https://62b52002da3017eabb151779.mockapi.io/producto/' + this.productos.id, {
        method: "PUT",
        headers: {
