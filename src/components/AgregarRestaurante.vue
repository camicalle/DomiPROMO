    ...
    <section>
      <article>
        <form class="formulario" @submit.prevent="agregar">
          <div class="form">
            <h3 class="bold">Agregar Restaurante</h3>
            <input class="bold" type="text" v-model="restaurante.nombre" placeholder="Nombre del restaurante" required />
            <input class="bold" type="text" v-model="restaurante.direccion" placeholder="Direccion del restaurante" required />
            <input class="bold" type="tel" v-model="restaurante.telefono" placeholder="Telefono del restaurante" required />
            <input class="bold" type="email" v-model="restaurante.correo" placeholder="Correo del restaurante" required />
            <div class="enviar">
...
export default {
  ...
  methods: {
    agregar(event) {
      ...
      .then((data) => {
        console.log(data);        
        alert("Restaurante Agregrado satisfactoriamente!");
