    ...
    <section>
      <article>
        <form class="formulario" @submit.prevent="editar">
          <div class="form">
            <h3 class="bold">Editar Cliente</h3>
            <input class="bold" type="text" v-model="clientes.nombre" placeholder="Nombre del cliente" required />
            <input class="bold" type="text" v-model="clientes.direccion" placeholder="Direccion del cliente" required />
            <input class="bold" type="tel" v-model="clientes.telefono" placeholder="Telefono del cliente" required />
            <input class="bold" type="email" v-model="clientes.correo" placeholder="Correo del cliente" required />
            <div class="enviar">
...
export default {
  ...
  created(){
    fetch('https://62b52002da3017eabb151779.mockapi.io/cliente/' + this.$route.params.id)
  ...
  methods: {
    editar(event) {
      fetch('https://62b52002da3017eabb151779.mockapi.io/cliente/' + this.clientes.id, {
        method: "PUT",
        headers: {
