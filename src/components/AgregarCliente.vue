    ...
    <section>
      <article>
        <form class="formulario" @submit.prevent="agregar">
          <div class="form">
            <h3 class="bold">Agregar Cliente</h3>
            <input class="bold" type="text" v-model="cliente.nombre" placeholder="Nombre del cliente" required />
            <input class="bold" type="text" v-model="cliente.direccion" placeholder="Direccion del cliente" required />
            <input class="bold" type="tel" v-model="cliente.telefono" placeholder="Telefono del cliente" required />
            <input class="bold" type="email" v-model="cliente.correo" placeholder="Correo del cliente" required />
            <div class="enviar">
